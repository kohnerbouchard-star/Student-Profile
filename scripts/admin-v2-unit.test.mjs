...
test("Admin v2 navigation is canonical, unique, permission-bound, and migrates only Overview, Store, Market, and Messages", () => {
  ...
  assert.deepEqual(migratedRoutes.map((route) => route.id), ["overview", "market", "store", "messages"]);
  assert.deepEqual(
  ...
  assert.deepEqual(
    ...
    ["banking", "loans", "business", "crafting", "marketplace", "inventory", "world-management", "news-events", "progression"],
  );
