...
test("Admin v2 navigation is canonical, unique, permission-bound, and migrates Overview, Store, Market, and Crafting", () => {
  ...
  assert.deepEqual(migratedRoutes.map((route) => route.id), ["overview", "market", "crafting", "store"]);
  assert.deepEqual(
  ...
  assert.deepEqual(
    ...
    ["banking", "loans", "business", "marketplace", "inventory", "world-management", "news-events", "messages", "progression"],
  );
