...
test("Admin v2 navigation is canonical, unique, permission-bound, and migrates Overview, Store, Market, and World Management", () => {
  ...
  assert.deepEqual(migratedRoutes.map((route) => route.id), ["overview", "market", "store", "world-management"]);
  assert.deepEqual(
