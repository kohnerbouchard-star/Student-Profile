...
function validateManifest(manifest) {
  ...
  assert(
    manifest?.manifestId === "econovaria.edge-functions.v1",
  ...
  return { canonical, temporary, retired };
}
...
async function main() {
  ...
  process.stdout.write(`${JSON.stringify({
    ...
    staging: {
      ...
      invalidDigests: result.staging.invalidDigests,
      invalidVersions: result.staging.invalidVersions,
    ...
    production: {
      ...
      invalidDigests: result.production.invalidDigests,
      invalidVersions: result.production.invalidVersions,
      retiredPresent: result.production.retiredPresent,
    },
