...
const playerImpactPaths = new Set([
  ...
  "scripts/runtime-trusted-types-contract.test.mjs",
...
const exactAllowed = new Set([
  ...
  ".github/workflows/player-multiplayer-load-e2e.yml",
  ...
  "backend/src/domains/stocks/infrastructure/supabasePlayerStockWatchlistRepository.ts",
  "backend/src/domains/stocks/infrastructure/supabasePlayerStockWatchlistRepository.test.ts",
  ...
  "backend/supabase/migrations/20260727103000_fix_arrival_grant_checking_account_v1.sql",
