export const PLAYER_ENDPOINTS = Object.freeze({
  ...
  businessIpos: { method: "GET", path: "/business/ipos" },
  businessIpoPropose: { method: "POST", path: "/business/ipos/proposals" },
  businessIpoVote: { method: "POST", path: "/business/ipos/:ipoKey/votes" },
  businessIpoSubscribe: { method: "POST", path: "/business/ipos/:ipoKey/subscriptions" },
