...
const ROUTE_BUILDERS = Object.freeze({
  ...
  progressionUnlock: ({ params = {}, payload = {} }) => ({
    method: "POST",
    ...
    payload: {
      idempotencyKey: idempotencyKey(payload, "progressionUnlock"),
    },
  }),

  progressionClaim: ({ params = {}, payload = {} }) => ({
    method: "POST",
    ...
    payload: {
      idempotencyKey: idempotencyKey(payload, "progressionClaim"),
    },
  }),
