...
} from "../../../src/domains/store/api/storeCatalogRouteHandler.ts";
import type {
  StoreCatalogRouteResult,
} from "../../../src/domains/store/contracts/storeCatalogContracts.ts";
import {
...
async function handleStaffStoreCatalogRequest(
  request: Request,
