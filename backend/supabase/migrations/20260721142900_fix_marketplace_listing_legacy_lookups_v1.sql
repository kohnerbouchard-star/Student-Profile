...
-- Qualify the private legacy listing projection function used only by the
-- authoritative public reservation wrapper. It remains non-executable by API roles.
create or replace function public.create_marketplace_listing_projection_legacy_v2(
