...
begin
  if p_game_session_id is null
    ...
    or p_trigger_key !~ '^[A-Za-z0-9][A-Za-z0-9._:-]{0,159}$'
...
) is 'Atomically records one campaign event transition and durable effect commands. V2 now persists the required trigger_key and enforces the table-compatible 160-character trigger-key limit.';
