-- Fix store purchase execution RPC hash generation under restricted search_path.
-- Supabase installs pgcrypto functions in the extensions schema, while this RPC uses
-- set search_path = public, pg_temp. Qualify digest to avoid runtime lookup failures.
