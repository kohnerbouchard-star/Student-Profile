...
--   registry: 207 tables
--   FK graph: 456 edges
--   direct delete order: 206 tables
...
begin
  ...
  select registry_sha256, table_count
    into v_registry_sha, v_registry_count
  from public.get_game_data_purge_registry_digest_v1();
  if v_registry_sha <> '7bcda40cfba058b0a712782671ba91cb3c50b29adb1bbe105dfbf84998907ac3'
     or v_registry_count <> 207 then
  ...
  select fk_graph_sha256, edge_count
    into v_fk_sha, v_edge_count
  from public.get_game_data_purge_fk_graph_digest_v1();
  if v_fk_sha <> 'fe88cafd56ca4c21ab3c1d34385e21f4c3d8be201eae44ee7f5539a34a98f329'
     or v_edge_count <> 456 then
  ...
  select order_sha256, table_count
    into v_order_sha, v_order_count
  from public.get_game_data_purge_delete_order_digest_v1();
  if v_order_sha <> '19c4c6bf8e005c53c6dddfadcf63d5c5e955307a63d93b0343f48d73c4504897'
     or v_order_count <> 206 then
