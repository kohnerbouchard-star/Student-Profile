...
export const PLAYER_CAPABILITY_REGISTRY: readonly PlayerCapabilityDomain[] = Object.freeze([
  ...
  },
  {
    ...
    status: "read_only",
    summary: "Owned inventory is authoritative; item-use and redemption semantics are not connected.",
    playerReads: ["inventory"],
    playerWrites: [],
    missingPlayerWrites: ["inventoryUse"],
    adminSurface: "missing",
    adminSummary: "A redemption queue with approve, reject, fulfill, and audit controls is required.",
