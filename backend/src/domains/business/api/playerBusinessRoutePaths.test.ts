...
Deno.test("Business route authority recognizes Edge service prefixes", () => {
  assertEquals(readPlayerBusinessRoutePath("/player-api/players/me/business/stockroom"), {
    kind: "businessRead",
    resource: "stockroom",
  });
  assertEquals(readPlayerBusinessRoutePath("/functions/v1/classroom-api/players/me/business/recipes"), {
    kind: "businessRead",
    resource: "recipes",
  });
