...
type LegacyBusinessMutationRoute = Exclude<
  PlayerBusinessRoute,
...
async function executeRoute(
  ...
  route: LegacyBusinessMutationRoute,
  body: Record<string, unknown>,
