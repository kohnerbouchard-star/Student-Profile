...
Deno.test("player capability manifest is generated from the reviewed endpoint allowlist", () => {
  ...
  assertEquals(manifest.capabilities.routes.progression, true);
  ...
  assertEquals(manifest.capabilities.actions.progressionUnlock, true);
  assertEquals(manifest.capabilities.actions.progressionClaim, true);
  ...
  assertEquals(endpointKeys.includes("progression"), true);
  assertEquals(endpointKeys.includes("progressionUnlock"), true);
  assertEquals(endpointKeys.includes("progressionClaim"), true);
