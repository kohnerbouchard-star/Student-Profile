...
|---:|---|---|---:|---|---|---|---|
| 1 | `P0-001`, `P0-002`, `P0-007`, `P0-008`; authoritative roadmap, collision control, queue, final go/no-go | PR #281 and #288 merged; reconciliation branch `docs/beta-controller-story-merge-v1` | 0 | Controller reconciliation CI pending after permanent roadmap diff | None for documentation authority | Controller authority complete; this reconciliation not yet authoritative | Reconcile PR #244 and the post-merge queue in the two controller documents, pass required final-head CI, and merge documentation only |
