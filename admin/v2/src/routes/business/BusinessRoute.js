    ...
    children: [
      ...
      createElement("dl", {
        ...
        children: [
          ...
          detailLine("Revenue total", amount(business.revenueTotal, business.currencyCode)),
          detailLine("Expense total", amount(business.expenseTotal, business.currencyCode)),
          detailLine("Profit total", amount(business.profitTotal, business.currencyCode)),
          detailLine("Valuation", amount(business.valuation, business.currencyCode)),
          detailLine("Reputation", number(business.reputationScore)),
          detailLine("Capacity units", number(business.capacityUnits)),
          detailLine("Demand index", number(business.demandIndex, { maximumFractionDigits: 4 })),
...
function catalog({ model, filters, onFiltersChange, onDetail, onCompliance }) {
  ...
  const table = AdminDataTable({
    ...
    columns: [
      ...
      { key: "valuation", label: "Valuation", align: "end", render: (value, business) => amount(value, business.currencyCode) },
      { key: "profitTotal", label: "Profit", align: "end", render: (value, business) => amount(value, business.currencyCode) },
      {
        key: "actions",
        label: "Actions",
        align: "end",
