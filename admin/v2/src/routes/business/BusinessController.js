...
function normalizeBusiness(row, index) {
  ...
  return Object.freeze({
    ...
    revenueTotal: nonnegative(row.revenue_total ?? row.revenueTotal),
    expenseTotal: nonnegative(row.expense_total ?? row.expenseTotal),
    profitTotal: finite(row.profit_total ?? row.profitTotal),
    valuation: nonnegative(row.valuation),
    ...
    demandIndex: nonnegative(row.demand_index ?? row.demandIndex),
